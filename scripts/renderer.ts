...
class Renderer {
    ...
    webgl
    map
    readonly fov = 45 * Math.PI / 180
    readonly near = 0.1;
    readonly far = 100;
    readonly modelViewMatrix = mat4.translate(0, 0, -6)
    ...
    render(dt) {
        ...
        gl.clearColor((this.t * 1000 % 1000) / 1000, 0, 0, 1)
        gl.clearDepth(1)
        ...
        gl.uniformMatrix4fv(this.shaders[0].uniform["modelViewMatrix"], false, this.modelViewMatrix)
